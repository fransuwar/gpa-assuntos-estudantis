...
public class VisualizarAlterarSteps {
	...
	public void parecerFinalClicado(){
		driver.findElement(By.xpath(".//*[@id='visualizar-inscricoes']/thead/tr/th[6]")).click();
	}
	...
	public void alteracaoResultadoConcluida(String alteracao){
		...
		case "DEFERIDO":
			driver.findElement(By.xpath(".//div[@id='inscResult']")).click();
			driver.findElement(By.xpath("//*[@id='modal1']/div/form/div[2]/div/input")).click();
			classe = driver.findElement(By.xpath("//div[@id='modal1']/div/form/div[@class='col s12 input-field']/div/ul/li[1]"));
		...
		case "INDEFERIDO":
			driver.findElement(By.xpath(".//div[@id='inscResult']")).click();
			driver.findElement(By.xpath("//*[@id='modal1']/div/form/div[2]/div/input")).click();
			classe = driver.findElement(By.xpath("//div[@id='modal1']/div/form/div[@class='col s12 input-field']/div/ul/li[2]"));
			driver.findElement(By.xpath("//*[@id='modal1']/div/form/div[4]/a")).click();
			assertEquals(classe.getAttribute("class"), "active");
			break;
		case "NAO_AVALIADO":
			driver.findElement(By.xpath(".//div[@id='inscResult']")).click();
			driver.findElement(By.xpath("//*[@id='modal1']/div/form/div[2]/div/input")).click();
			classe = driver.findElement(By.xpath("//div[@id='modal1']/div/form/div[@class='col s12 input-field']/div/ul/li[3]"));
			driver.findElement(By.xpath("//*[@id='modal1']/div/form/div[4]/a")).click();
			assertEquals(classe.getAttribute("class"), "active");
			break;
	}
