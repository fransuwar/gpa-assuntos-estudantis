...
import br.ufc.npi.auxilio.test.steps.ModificarColocacaoSteps;

@RunWith(SpringJUnit4ClassRunner.class)
public class ModificarColocacaoTest extends JUnitStories{

    public ModificarColocacaoTest() {
    ...
    public InjectableStepsFactory stepsFactory() {
        return new InstanceStepsFactory(configuration(), new ModificarColocacaoSteps());
    }
