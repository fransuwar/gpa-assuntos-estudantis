...
import br.ufc.npi.auxilio.test.steps.VisualizarAlterarSteps;


@RunWith(SpringJUnit4ClassRunner.class)
public class VisualizarAlterarTest extends JUnitStories{
	 public VisualizarAlterarTest() {
	    ...
	    public InjectableStepsFactory stepsFactory() {
	        return new InstanceStepsFactory(configuration(), new VisualizarAlterarSteps());
	    }
