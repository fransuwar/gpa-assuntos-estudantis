...
import br.ufc.npi.auxilio.test.steps.ExportarResultadoSteps;

@RunWith(SpringJUnit4ClassRunner.class)
public class ExportarResultadoTest extends JUnitStories{

    public ExportarResultadoTest() {
    ...
    public InjectableStepsFactory stepsFactory() {
        return new InstanceStepsFactory(configuration(), new ExportarResultadoSteps());
    }
