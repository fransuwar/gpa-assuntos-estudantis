...
<link href="<c:url value="/css/jquery.buttons.dataTables.min.css" />" rel="stylesheet" />
<link href="<c:url value="/css/datepicker3.css"/>" rel="stylesheet">
<link href="<c:url value="/css/font-awesome-4.4.0/css/font-awesome.min.css" />" rel="stylesheet" />
