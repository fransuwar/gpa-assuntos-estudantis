...
public class SelecaoController {
	...
	// "inscritos/relatorioVisita/{idAluno}/{idSelecaoBolsa}")
	// public String cadastrarRelatorio(@PathVariable("idAluno") Integer
	// idAluno,
	// @PathVariable("idSelecaoBolsa") Integer idSelecaoBolsa, Model modelo) {
	// return "redirect:/relatorioVisita/cadastrar/" + idAluno + "/" +
	// idSelecaoBolsa;
	// }

	// @RequestMapping(value = "inscritos/informacoesRelatorio/{id}")
	// public String visualizarRelatorioVisita(@PathVariable("id") Integer id,
	// Model modelo) {
	...
	// public String visualizarFormularioAluno(@PathVariable("idaluno") Integer
	// id, Model model) {
	// return null;
	// }
