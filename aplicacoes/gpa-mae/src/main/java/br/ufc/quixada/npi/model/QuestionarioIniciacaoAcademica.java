...
public class QuestionarioIniciacaoAcademica {
	...
	public String toString() {
		return "QuestionarioIniciacaoAcademica [id=" + id + ", bolsa=" + bolsa
				+ ", pessoas=" + pessoas + ", aluno=" + aluno
				+ ", enderecoAtual=" + enderecoAtual + ", numero=" + numero
				+ ", complemento=" + complemento + ", bairro=" + bairro
				+ ", estadoFamilia=" + estadoFamilia + ", estadoAtual="
				+ estadoAtual + ", cep=" + cep + ", cidade=" + cidade
				+ ", pontoReferencia=" + pontoReferencia + ", telefoneFixo="
				+ telefoneFixo + ", telefoneCelular=" + telefoneCelular
				+ ", email=" + email + ", enderecoFamilia=" + enderecoFamilia
				+ ", numeroFamilia=" + numeroFamilia + ", bairroFamilia="
				+ bairroFamilia + ", ufFamilia=" + ufFamilia
				+ ", complementoFamilia=" + complementoFamilia
				+ ", cepFamilia=" + cepFamilia + ", cidadeFamilia="
				+ cidadeFamilia + ", pontoReferenciaFamilia="
				+ pontoReferenciaFamilia + ", anosEstudoPrivado="
				+ anosEstudoPrivado + ", nivelInstrucaoMae="
				+ nivelInstrucaoMae + ", nivelInstrucaoPai="
				+ nivelInstrucaoPai + ", resideAtualmente=" + resideAtualmente
				...
				+ ", campusPreferido=" + campusPreferido
