				...
				<form:form id="questionarioForm" role="form"
					...
					<fieldset>
						...
						<div class="form-group">
							<fieldset>
								<label for="enderecoAtual" class="col-sm-2 control-label">Rua/Av
									:</label>
								<div class="col-sm-4">
									<form:input id="enderecoAtual" type="text" path="enderecoAtual"
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<form:input id="cep" path="cepFamilia" cssClass="form-control"
							...
							<div class="col-sm-2">
								<form:textarea id="bairroFamilia" type="text"
									path="bairroFamilia" cssClass="form-control"
									placeholder="Bairro" />
								<div class="error-validation">
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<form:input id="telefone" path="telefoneFixo"
									cssClass="form-control" placeholder="formato (00) 0000-0000" />
								<div class="error-validation">
					...
					<div class="form-group">
						<label for="enderecoFamilia" class="col-sm-2 control-label">Rua/Av
							:</label>
						<div class="col-sm-4">
					...
					<div class="form-group">
						...
						<div class="col-sm-2">
							<form:input id="cepFamilia" path="cep" cssClass="form-control"
								placeholder="CEP" />
							<div class="error-validation">
						...
						<div class="col-sm-2">
							<form:textarea id="bairro" type="text" path="bairro"
								cssClass="form-control data" placeholder="Bairro" />
							<div class="error-validation">
					...
					<fieldset>
						...
						<div class="form-group">
							<label for="reside_atualmente" class="col-sm-2 control-label">Com
						...
						<div class="form-group">
							<label for="reside_atualmente" class="col-sm-2 control-label">Como
								define a Localidade na qual vive atualmente? :</label>
							<div class="col-sm-6">
								<form:input id="definicaoLocalAtual" path="definicaoLocalAtual"
						...
						<div class="col-sm-4">
							<form:input id="qtdAparelhoSom" type="number" min="0"
								path="qtdAparelhoSom" cssClass="form-control" placeholder="Fone" />
							<div class="error-validation">
						...
						<div class="col-sm-4">
							<form:input id="qtdTelevisao" type="number" min="0"
								path="qtdTelevisao" cssClass="form-control" placeholder="Fone" />
							<div class="error-validation">
						...
						<div class="col-sm-4">
							<form:input id="qtdRadio" type="number" min="0" path="qtdRadio"
						...
						<div class="col-sm-4">
							<form:input id="qtdAutomovel" type="number" min="0"
								path="qtdAutomovel" cssClass="form-control" placeholder="Fone" />
							<div class="error-validation">
						...
						<div class="col-sm-4">
							<form:input id="qtdMotocicleta" type="number" min="0"
								path="qtdMotocicleta" cssClass="form-control" placeholder="Fone" />
							<div class="error-validation">
						...
						<div class="col-sm-4">
							<form:input id="qtdGeladeira" type="number" min="0"
								path="qtdGeladeira" cssClass="form-control" placeholder="Fone" />
							<div class="error-validation">
						...
						<label for="qtd_celular_residentes" class="col-sm-2 control-label">Celular
							Residentes:</label>
						<div class="col-sm-4">
						...
						<div class="col-sm-4">
							<form:input id="qtdComputador" type="number" min="0"
								path="qtdComputador" cssClass="form-control" placeholder="Fone" />
							<div class="error-validation">
						...
						<div class="col-sm-4">
							<form:input id="qtdFogaoGas" type="number" min="0"
								path="qtdFogaoGas" cssClass="form-control" placeholder="Fone" />
							<div class="error-validation">
								<form:errors path="qtdFogaoGas"></form:errors>
							</div>
						</div>

						<label for="qtd_maquina_costura" class="col-sm-2 control-label">Máquina
							de Costura:</label>
						<div class="col-sm-4">
						...
						<label for="qtd_comodos_sem_banheiro"
							class="col-sm-2 control-label">Comodo sem Banheiro:</label>
						<div class="col-sm-4">
						...
						<div class="col-sm-4">
							<form:input id="qtdBanheiros" type="number" min="0"
								path="qtdBanheiros" cssClass="form-control" placeholder="Fone" />
							<div class="error-validation">
						...
						<label for="qtd_empregados_domesticos"
							class="col-sm-2 control-label">Empregados Domesticos:</label>
						<div class="col-sm-4">
							<form:input id="qtdEmpregadosDomesticos" type="number" min="0"
								path="qtdEmpregadosDomesticos" cssClass="form-control"
								placeholder="Fone" />
							<div class="error-validation">
						...
						<label for="totalMembrosFamilia" class="col-sm-5 control-label">Quantidade
							de Membros da Familia:</label>
						<div class="col-sm-1">
					...
					<fieldset>
						<div class="form-group">
							<label for="justificativaPedido" class="col-sm-1 control-label"></label>
							<div class="col-sm-11">
