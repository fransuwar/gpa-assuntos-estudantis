									...
									<div class="form-group">
										...
										<div class="col-sm-1">
											<form:input id="numeroFamilia" path="numeroFamilia"
												cssClass="form-control" placeholder="Num" data-mask="9999" required ="required"/>
									...
									<div class="form-group">
										...
										<div class="col-sm-2">
											<form:input id="cepFamilia" path="cepFamilia"
												...
												placeholder="Ex:63900000 " required ="required"/>
									...
									<div class="form-group">
										...
										<div class="col-sm-5">
											<form:input id="endereco" path="endereco"
												cssClass="form-control" placeholder="Rua /Av" required ="required"/>
									...
									<div class="form-group">
										...
										<div class="col-sm-1">
											<form:input id="numero" path="numero" cssClass="form-control"
												placeholder="Num" data-mask="9999" required ="required"/>
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<form:input id="referenciaFamilia" type="text"
												...
												placeholder="Ponto de Referencia" required ="required"/>
											<div class="error-validation" id="erro-cidadeAtual">
												<form:errors path="cidade"></form:errors>
											</div>
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-3">
											<form:input id="comQuemReside" path="comQuemReside"
												cssClass="form-control" placeholder="Ex: Familia, amigos" required ="required"/>
									...
									<div class="form-group">
										...
										<div class="col-sm-3">
											<form:input id="tipoResidencia" path="tipoResidencia"
												cssClass="form-control" placeholder="Ex: Casa/Apartamento" required ="required"/>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<form:textarea id="justificativaPedido" type="text"
												...
												placeholder="Justificativa do Pedido" rows="10" required ="required"/>
